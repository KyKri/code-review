...
export const algorithms: IAlgorithm[] = [
    ...
    },
    {
        _id: '',
        name: 'Quicksort',
        description: `Quicksort is a comparison sort, meaning that it can sort items of any type for which a "less-than" relation (formally, a total order) is defined.
